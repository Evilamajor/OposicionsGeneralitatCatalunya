...
export default function HistoriaCatalanaPage() {
  ...
  return (
    <div className="cultura-subpage">
      ...
      <div className="cultura-subpage-header">
        ...
        <h1 className="cultura-subpage-title">Història Catalana</h1>
      </div>

      <p className="cultura-subpage-desc">
        Principals fets històrics, personatges i etapes de la història de Catalunya.
      </p>
