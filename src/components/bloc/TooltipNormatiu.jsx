...
export default function TooltipNormatiu({ tipus, referencia, children }) {
  ...
  const tooltip = open ? createPortal(
    <div
      className="tooltip-bubble-shell"
      style={{
        position: 'fixed',
        top: `${position.top}px`,
    ...
    >
      ...
      >
        {info.titol && (
          <div className="tooltip-bubble-title">
            {info.titol}
          </div>
        )}
